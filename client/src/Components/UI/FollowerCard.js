...
function FollowerCard(props) {
    ...
    return (
        <div className="followerCardContainer" onClick={toProfileHandler}>
            <img src={followersMode ? (process.env.REACT_APP_AWS_IMAGE_URL + userData.loggedInUserProfilePicture) : (process.env.REACT_APP_AWS_IMAGE_URL + userData.followedUserProfilePicture)} className="followerCardImg"/>
